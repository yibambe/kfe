...
import { SignIntKfeComponent } from "./extra-pages/sign-int-kfe/sign-int-kfe.component";
...
@NgModule({
  ...
  declarations: [
    // start declaration new components
    SignIntKfeComponent,
    // end declaration new components
  ...
  exports: [
    // start exports new components
    SignIntKfeComponent,
    // end exports new components
    PageDashboardComponent,
    PageDashboard2Component,
    PageButtonComponent,
    PageCardComponent,
